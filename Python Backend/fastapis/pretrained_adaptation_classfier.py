...
def classify_adaptation(scenario):
    ...
    return {
        "predicted_adaptation_strategy": llm_pred_label,
        "latest_test_prediction": y_pred_labels[-1],
        "classification_report": classification_report(y_test_labels, y_pred_labels, output_dict=True)
    }

scenario = "What if average temperature increases by 2°C with lower soil health?"
classify_adaptation(scenario)
