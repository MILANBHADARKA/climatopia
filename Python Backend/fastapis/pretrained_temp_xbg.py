...
# Rescale the predicted temperature
    ...
    print(f"🌞 Predicted Temperature with LLM Scenario : {llm_pred_rescaled:.2f}°C")

    return {
        "meantemp": llm_pred_rescaled,
        "humidity": prediction["humidity"],
        "wind_speed": prediction["wind_speed"],
        "meanpressure": prediction["meanpressure"],
        "Economic_Impact_Million_USD": prediction["Economic_Impact_Million_USD"],
        "Total_Precipitation_mm": prediction["Total_Precipitation_mm"],
        "CO2_Emissions_MT": prediction["CO2_Emissions_MT"],
        "Crop_Yield_MT_per_HA": prediction["Crop_Yield_MT_per_HA"],
        "Pesticide_Use_KG_per_HA": prediction["Pesticide_Use_KG_per_HA"],
        "Fertilizer_Use_KG_per_HA": prediction["Fertilizer_Use_KG_per_HA"],
        "Soil_Health_Index": prediction["Soil_Health_Index"],
        "solar_generation": prediction.get("solar_generation", 0),
        "Temperature": llm_pred_rescaled
    }


predict_temp("What if half the earth becomes ice??")